...
#SBATCH --array=0-1
#CHANGE n above to the number of required jobs minus one 
...
# Your specific set of numbers to use as array indices
failed_array_indices=(0)

# Get the current array index
current_index=${failed_array_indices[$SLURM_ARRAY_TASK_ID - 1]}
...
gmx grompp -f $MDP/em.$LAMBDA.mdp -c $dir/0089.gro -p $dir/0089.top -o em.tpr -maxwarn 3 
...
gmx grompp -f $MDP/nvt.$LAMBDA.mdp -c ../EM/em.gro -p $dir/0089.top -o nvt.tpr -maxwarn 1
...
gmx grompp -f $MDP/npt.$LAMBDA.mdp -c ../NVT/nvt.gro -p $dir/0089.top -o npt.tpr -maxwarn 1
...
gmx grompp -f $MDP/prod.$LAMBDA.mdp -c $dir/lambda_$LAMBDA/NPT/npt.gro -p $dir/0089.top -o prod.tpr -maxwarn 1
...
echo "Job ID:             ${SLURM_ARRAY_JOB_ID}_${current_index}"
